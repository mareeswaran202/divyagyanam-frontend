export async function GET(request) {
  try {
    ...
    // Chennai coordinates for initial testing
    ...
    // 2. Get Daily Panchang
    const panchangResponse = await fetch(
      `https://api.prokerala.com/v2/astrology/panchang?${params.toString()}`,
      {
        headers: {
    ...
    console.error("Prokerala Panchang Error:", error);
